...
export const Loading: FC<LoadingProps> = ({ hidden }) => {
  ...
  return (
    <div className="loading" style={{ opacity: hidden ? 0 : opacity }}>
      <svg width="200" height="200" xmlns="http://www.w3.org/2000/svg" aria-label="Loading animation">
        ...
        <mask id="loading__mask">
          <rect className="loading__rect loading__rect--masked" x="65" y="65" width="70" height="70" rx="6" />
        </mask>
