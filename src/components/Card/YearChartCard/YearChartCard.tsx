...
export const YearChartCard: FC<YearChartCardProps> = memo(({ data }) => {
  const { commitsPerMonthAndYear, commitsPerYear, years } = data;
  ...
  return <Chart className="year-chart-card" title="Years Chart" graphs={graphs} xLabels={MONTH_TITLES_SHORT} />;
});
